...
Contar estas líneas y extraer los valores en punto flotante de cada una de ellas para finalmente calcular la media de
esos valores y generar una salida como la que se muestra a continuación. Media de correo basura: 0.750718518519
